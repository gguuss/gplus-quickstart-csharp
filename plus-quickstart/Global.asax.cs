...
namespace Google.Plus.Samples.Quickstart
{
    ...
    /// <summary>Routes the sample endpoints to the handler.</summary>
    /// @author class@google.com (Gus Class)
    public class Global : System.Web.HttpApplication
    {
        /// <summary>Implements the application start interface.</summary>
        /// <param name="sender">Object that started the application.</param>
        ...
        /// <summary>Registers all of the RESTful route maps.</summary>
